...
**Angular:** A `<responsive-table>` component using Angular's `*ngFor` directive for template-driven rendering. Uses Angular 17 UMD bundles from CDN with no build step required. See `demo/angular/`.
